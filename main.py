...
def main_menu():
    ...
    # Step 2: Show Menu based on Role
    while True:
        print(f"\n===== {role} Menu =====")
        ...
        if role == "Office Clerk":
            ...
            print("2. Delete Student (Dropout)")
        ...
        # ---------------------- FACULTY / TEACHER MENU ----------------------
            ...
            print("4. Sort / Filter Students")  # ✅ Added this option
            print("5. Exit")
            ...
            if choice == "1":
                ...
                sort_filter_students()  # ✅ Calls your sorting/filtering code
            elif choice == "5":
                print("Exiting...")
                break
            else:
        ...
        # ---------------------- HOD / ADMIN MENU ----------------------
            ...
            if choice == "1":
                generate_report()  # HOD sees summary using same report function
            elif choice == "2":
                filename = input("Enter filename to export data: ")
                bulk_import(filename)  # Or replace with your export logic if needed
            elif choice == "3":
                print("Exiting...")
                break
            else:
